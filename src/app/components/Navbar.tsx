  ...
  return (
    <div className=' w-full h-20  flex items-center justify-around  border-b-2 border-[#b3aeae]'>
      ...
      <div className="search relative">
        <div className="input">
            <input className=' bg-gray-200 p-2 w-[150px] md:w-[220px] rounded-md' type="text" placeholder='What are you looking for?' />
        </div>
      ...
      <div className="icons flex gap-2">
        ...
        {/* <Image src={'/Fill Heart.png'} width={32} height={32} alt='like'/> */}
        <Link href={'/cart'}><Image src={'/Cart1.png'} width={32} height={32} alt='cart'/></Link>
